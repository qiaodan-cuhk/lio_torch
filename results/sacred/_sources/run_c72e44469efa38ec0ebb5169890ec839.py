...
def run_sequential(args, logger):
    ...
    scheme = {
        ...
        "state_dims": {"vshape": (args.state_dims,)},   # [3, 9, 48]
        "obs_dims": {"vshape": (args.obs_dims,)},   # [3, 9, 9]
    }
...
def args_sanity_check(config, _log):
    ...
    # check yaml params
    # if 'lr_actor' in config_dict:
    #     config_dict['lr_actor'] = float(config_dict['lr_actor'])
    # if 'lr_cost' in config_dict:
    #     config_dict['lr_cost'] = float(config_dict['lr_cost'])
    # if 'lr_opp' in config_dict:
    #     config_dict['lr_opp'] = float(config_dict['lr_opp'])
    # if 'lr_reward' in config_dict:
    #     config_dict['lr_reward'] = float(config_dict['lr_reward'])
